...
const ListElement = ({items, className = ''}: ElementProps) => {
    return (
...
export const Footer: FC = () => {
    return (
        <footer className="bg-indigo-900 text-white" aria-labelledby="footer-heading">
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="grid grid-cols-2 gap-8 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <List title="My account" items={menuGroupItems.account}>
                                <ListElement className="lg:ml-6" items={menuGroupItems.profile}/>
                            </List>
                            <List title="Need Help?" items={menuGroupItems.help}/>
                        </div>
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <List title="Buy an Item" items={menuGroupItems.buy}/>
                            <List title="Legal" items={menuGroupItems.legal}/>
                        </div>
                    </div>

                    <div className="mt-12 md:mt-0 space-y-8 xl:col-span-1 order-last lg:order-first">
                        <div className="flex items-center">
                            <img className="h-10" src={Logo} alt={"Mintable"}/>
